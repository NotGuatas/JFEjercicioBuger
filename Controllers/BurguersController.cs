...
namespace JFEjercicioBuger.Controllers
{
    public class BurguersController : Controller
    {
        ...
        public BurguersController(JFEjercicioBugerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurguerId,Name,WithCheese,Price")] Burguer burguer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurguerId,Name,WithCheese,Price")] Burguer burguer)
        {
